...
Most icon packs are variations on a theme. VS Seti Plus is a ground-up redesign. Every icon — all 200+ of them — was drawn in Adobe Illustrator with one goal: **recognition at a glance, even at the smallest scale.**

### The 4px Recognition Rule

Every icon is hand-tuned for high-contrast visibility. Whether your sidebar is fully expanded or collapsed to its minimum width, the silhouette and color of each icon remain distinct and identifiable. No two file types share the same visual signature.
...
> **Seti Plus (Dark Professional)** is currently in development — a refined middle-ground for all-day work.
